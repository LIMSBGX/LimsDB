<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SampleAcceptanceList.aspx.cs" Inherits="CaliberEdap_Sample.SampleAcceptanceList" %>
        ...
        <asp:Table ID="tt" runat="server" CellPadding="0" CellSpacing="1"
            ...
            <asp:TableRow>
                <asp:TableCell CssClass="MainHead" ColumnSpan="7">
                    <asp:Literal ID="MainTitleLtrl" runat="server">Sample List</asp:Literal>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell><span style="float:left;margin-top: 3px; padding-right: 10px;">From: <input type="text" id="datepickerFrom" runat="server"/></span> <span style="float:left;margin-top: 3px;padding-right: 10px;">To: <input type="text" runat="server" id="datepickerTO" /></span>
                                           ...
                                           <asp:GridView ID="GridView1" Runat="server" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Protocol Description" DataField="SMP_ACP_PRT_DESC" 
                                                     ...
                                                     <asp:BoundField HeaderText="Pathologist Name" DataField="SMP_ACP_EXT_REF" 
                                                     SortExpression="SMP_ACP_EXT_REF"></asp:BoundField>
                                                     
                                                     <asp:BoundField HeaderText="Comments / Remarks" DataField="SMP_ACP_REMARKS" 
                                                     SortExpression="SMP_ACP_REMARKS"></asp:BoundField>
                                                     ...
                                                     SortExpression="SMP_ACP_REG_ON"></asp:BoundField>
                                                      ...
                                                      <asp:BoundField HeaderText="Print Option" DataField="SMP_ACP_PRINTED" 
                                                     SortExpression="SMP_ACP_PRINTED"></asp:BoundField>
