<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Userlogin.aspx.cs" Inherits="BiogenexLims.Userlogin" %>
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-40 p-b-40">
            ...
            <form id="form1" runat="server" class="login100-form validate-form">
				...
				<div class="wrap-input100 validate-input m-b-20 " data-validate="Enter username or email">
                    ...
                    <asp:TextBox ID="textUserID" runat="server" CssClass="validate[required] w-88 m-l-10 m-b-2 m-t-2   " placeholder="UserName" />
				...
				<div class="text-center">
					<a href="UserRegistration.aspx" class="txt2 hov1">
						Register
					</a>
				</div>
