<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SlideInformation.aspx.cs" Inherits="BiogenexLims.SlideInformation" %>
    ...
    <div>
        <div class="container">
          <div class="wrapper">
              ...
              <div class="box">
                   <div class="content"> Barrier Slides 18 X 18</div>
              ...
              <div class="box">
                   <div class="content"> Barrier Slides 25 X 25</div>
                   <div class="sub-conetent"> 
              ...
              <div class="box">
                   <div class="content"> Barrier Slides 25 X 40<</div>
                   <div class="sub-conetent"> 
