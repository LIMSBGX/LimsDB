...
{
    public partial class Table_BufferInfo : System.Web.UI.Page
    {
        ...
        public void LoadExistingRecords()
        {
            ...
            string query = "SELECT LM_BUFFERTYPE,LM_STOCK,LM_CONSUMED,FORMAT(LM_STOCKUPDATED, 'dd-MM-YYYY') as LM_STOCKUPDATED  FROM lm_Buffers where LM_BUFFERTYPE='IHC' or LM_BUFFERTYPE='DEWAX' ";//" where LM_INSID='" + InsId + "'";
            try
            {
