...
{
    public partial class Table_pipetteInfo : System.Web.UI.Page
    {
        ...
        public void LoadExistingRecords()
        {
            ...
            string query = "SELECT LM_TIPTYPE,LM_CONSUMED,LM_ENTRYSTOCK, FORMAT(LM_STOCKUPDATED, 'dd-MM-YYYY') as LM_STOCKUPDATED  FROM lm_pipette";//" where LM_INSID='" + InsId + "'";
            try
            {
