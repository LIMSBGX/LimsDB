<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Table-CoverSlipInfo.aspx.cs" Inherits="BiogenexLims.Table_CoverSlipInfo" %>
     ...
     <asp:Table ID="tt" runat="server" CellPadding="0" CellSpacing="1" 
            ...
            <asp:TableRow>
                <asp:TableCell CssClass="MainHead" ColumnSpan="7">
                    <asp:Literal ID="MainTitleLtrl" runat="server"> CoverSlips</asp:Literal>
               </asp:TableCell>                    
            </asp:TableRow>
            <asp:TableRow>
                                            ...
                                            <asp:GridView ID="GridView1" Runat="server" 
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="#">
                                                     ...
                                                     <asp:BoundField HeaderText="Type" DataField="LM_COVERSLIPTYPE" 
                                                     SortExpression="LM_COVERSLIPTYPE"></asp:BoundField>
