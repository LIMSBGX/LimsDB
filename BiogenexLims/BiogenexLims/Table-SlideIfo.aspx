<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Table-SlideIfo.aspx.cs" Inherits="BiogenexLims.Table_SlideIfo" %>
     ...
     <asp:Table ID="tt" runat="server" CellPadding="0" CellSpacing="1" 
            ...
            <asp:TableRow>
                <asp:TableCell CssClass="MainHead" ColumnSpan="7">
                    <asp:Literal ID="MainTitleLtrl" runat="server"> Slides</asp:Literal>
               </asp:TableCell>                    
            </asp:TableRow>
            <asp:TableRow>
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="#">
                                                     <ItemTemplate>
                                                      ...
                                                      <asp:BoundField HeaderText="Type" DataField="LM_SLIDETYPE" 
                                                     SortExpression="LM_SLIDETYPE"></asp:BoundField>
                                                     <asp:BoundField HeaderText="Stock" DataField="LM_EntryStock" 
